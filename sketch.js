...
function Tela5() {
    ...
    rect(20, 20, 400, 35, 10); // desenha o balão de instruções
    fill(255); // define a cor do texto para branco
    textSize(18); // define o tamanho da fonte
    textAlign(LEFT, TOP); // alinha o texto à esquerda e no topo
    text("Clique nos ingredientes para adicionar na tigela", 30, 30); // exibe a instrução
...
function Tela7() {
    ...
    if (cliente) {
        ...
        fill(140); // define a cor do texto de instrução para cinza
        textSize(14); // define o tamanho da fonte //
